...
export default class Fumi extends BaseInput {
  ...
  _margin_dir = ({ value }) => {
    ...
    else return { marginRight: value, paddingRight: 0 };
  };
  _direction = ({ value }) => {
      ...
      >
        <TouchableWithoutFeedback onPress={this.focus}>
          <AnimatedIcon
            ...
            style={{
              position: "absolute",
              ...this._direction({ value: inputPadding }),
              // left: inputPadding,
        ...
        <View
          style={[
            ...
            {
              height: inputHeight,
              ...this._direction({ value: iconWidth + 8 })
              // left: iconWidth + 8
            }
          ]}
        />
        <TouchableWithoutFeedback onPress={this.focus}>
          <Animated.View
            style={{
              position: "absolute",
              ...this._direction({ value: iconWidth + inputPadding }),
        ...
        <TextInput
          ...
          style={[
            styles.textInput,
            {
              ...
              ...this._margin_dir({ value: iconWidth + inputPadding }),
              color: iconColor
            },
            inputStyle
          ]}
